...
trait ApiResponse
{
    ...
    public function respondError(?string $message, \Exception $e): JsonResponse
    {
        return $this->apiResponse(
            [
                'code'      => Response::HTTP_BAD_REQUEST,
                'message'   => $message ?? 'Something went wrong. We are working on a fix.',
    ...
    public function respondErrors(?string $messages = null, \Exception $e): JsonResponse
    {
        return $this->apiResponse(
            [
                'app_errors'  => $messages ?? ['nohandled' => 'Unknown error. E:881'],
                'debug'       => config('app.debug') ? \ErrorHelper::exceptionToJson($e) : false
            ],
            Response::HTTP_BAD_REQUEST
        );
    }
